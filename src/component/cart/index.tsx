...
const CartOrderSummary: FC<{}> = () => (
  <div className=" p-5 bg-gray-800 rounded overflow-visible">
    ...
    <div>
      <label htmlFor="" className="text-xs text-gray-400 font-medium inline-block mb-3 text-sm uppercase">
        Shipping
      </label>
    ...
    <div className="py-10">
      <label htmlFor="promo" className="text-xs text-gray-400 font-semibold inline-block mb-3 text-sm uppercase">
        Promo Code
      </label>
...
export { CartProductInfo, CartOrderSummary };
